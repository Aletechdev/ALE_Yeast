...
nextflow run ../nf-core-sarek_3.5.1/3_5_1/main.nf -profile azureD4as,docker \
    ...
    -c ${run_folder}/bin/nextflow.config --tools snpeff,freebayes,mutect2 --split_fastq 0  \
    --snpeff_cache ${run_folder}/data/BakerYeast_reference/snpeff_cache --snpeff_db draft_ref.52
