...
nextflow run ../nf-core-sarek_3.5.1/3_5_1/main.nf -profile azureD4as,docker \
    ...
    -c ${run_folder}/bin/nextflow.config --tools snpeff,freebayes,controlfreec,manta,mutect2,cnvkit,msisensorpro,tiddit,haplotypecaller,deepvariant --split_fastq 0  \
    --joint_germline --joint_mutect2 --save_mapped --split_haplotypecaller_joint_vcf \
