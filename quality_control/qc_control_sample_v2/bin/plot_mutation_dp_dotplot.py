...
# Simplified categories for cleaner x-axis
category_labels = ['Exact Match', 'Fuzzy Match\n(100bp window)', 'Joint-GATK-HC\nOnly']
...
for category, positions in categories.items():
    ...
    for pos in positions:
        ...
        ax.scatter(x_jitter, dp, marker=marker, s=180, color=color,
                  alpha=0.7, edgecolors='white', linewidth=1.5)

# Customize plot
ax.set_ylabel('Read Depth (DP)', fontweight='bold')
